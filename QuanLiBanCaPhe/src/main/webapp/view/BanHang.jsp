...
<link rel="stylesheet" href="./view/BanHang.css" />
...
<body>
	<div class="app">
		<div class="header">
			...
			<!-- Tab items -->
			<ul class="tabs">
				<li class="tab-item active"><a class="nav-link" href="hienThiMenuController"><i
						class="tab-icon fa-solid fa-cash-register"></i> Bán hàng</a></li>
				<li class="tab-item"><a class="nav-link" href="quanLyHoaDonController_nhanvien"><i
			...
			<div class="content__right col-sm-4">
				...
				<div class="payment">
					...
					<div class="payment__detail">
						<label for="payment-method">Phương thức thanh toán: </label> <select
							class="payment__method" name="payment-method" id="payment-method">
				...
				<div class="btn__wrapper">
					<a class="nav-link btn__link" href="luuHoaDonController"><button
							class="btn btn--save">
							<i class="btn__icon fa-solid fa-floppy-disk"></i> Lưu
						</button></a>
