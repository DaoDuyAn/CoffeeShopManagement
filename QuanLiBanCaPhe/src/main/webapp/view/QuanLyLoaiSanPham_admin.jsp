					...
					<div class="content__input">
						<form id="productForm" action="quanLyLoaiSanPhamController_admin"
							...
							<div class="payment__detail">
								<label>Mã sản phẩm: </label> <input name="malsp"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("malsp") != null ? request.getParameter("malsp") : "");%>" />
							</div>
							<div class="payment__detail">
								<label>Tên sản phẩm: </label> <input name="tenlsp"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("tenlsp") != null ? request.getParameter("tenlsp") : "");%>" />
							</div>
