...
<link rel="stylesheet" href="./view/AdminLTE.min.css">
<!-- AdminLTE Skins. Choose a skin from the css/skins
      folder instead of downloading all of them to reduce the load. -->
<link rel="stylesheet" href="./view/_all-skins.min.css">
					...
					<div class="content__input">
						<form id="productForm" action="quanLyNhanVienController_admin"
							...
							<div class="payment__detail">
								<label>Mã sản phẩm: </label> <input name="manv"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("manv") != null ? request.getParameter("manv") : "");%>" />
							</div>
							<div class="payment__detail">
								<label>Tên sản phẩm: </label> <input name="tennv"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("tennv") != null ? request.getParameter("tennv") : "");%>" />
							</div>
							<div class="payment__detail">
								<label>Ngày sinh: </label> <input name="ns"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("ns") != null ? request.getParameter("ns") : "");%>" />
							</div>
							<div class="payment__detail">
								<label>Giới tính: </label> <input name="gt"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("gt") != null ? request.getParameter("gt") : "");%>" />
							</div>
							<div class="payment__detail">
