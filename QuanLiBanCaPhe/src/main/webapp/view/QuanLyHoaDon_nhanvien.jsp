	...
	<div class="app">
		<div class="header">
			...
			<ul class="tabs">
				...
				<li class="tab-item active"><a class="nav-link" href="quanLyHoaDonController_nhanvien"><i
		...
		<div class="wrapper">
			...
			<div class="content">
				<div class="content__input">
					<form id="productForm" action="quanLyHoaDonController_nhanvien"
						method="POST">
							...
							<td class="text-center col-size">
								<div class="btn__wrapper2">
									<a class="nav-link btn__link"
										href="quanLyHoaDonController_nhanvien?mahd=<%=hd.getMaHoaDon()%>&nl=<%=hd.getNgayLap()%>&manv=<%=hd.getMaNhanVien()%>">
									...
									<button type="submit" form="productForm"
										...
										onclick="confirmDelete2('<%=hd.getMaHoaDon()%>')">
										<i class="btn__icon fa-solid fa-trash"></i> Xóa
									</button>
								</div>
