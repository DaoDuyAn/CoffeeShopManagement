...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
      ...
      " class="logo"> <!-- logo for regular state and mobile devices -->
				<cthdan class="logo-lg">
				<b>Admin</b>LTE</cthdan>
			</a>
								...
								<td class="text-center col-size">
									<div class="btn__wrapper2">
										<a class="nav-link btn__link"
											href="quanLyCTHDController_admin?mahd=<%=cthd.getMaHoaDon()%>&masp=<%=cthd.getMaSanPham()%>&sl=<%=cthd.getSoLuong()%>&dongia=<%=cthd.getDonGia()%>">
											<button class="btn btn--edit btn-new">
												<i class="btn__icon fa-solid fa-pen-to-square"></i> Sửa
											</button>
										</a>
										<button type="submit" form="productForm"
											class="btn btn--print btn-new ml" name="action" value="delete"
											onclick="confirmDelete2('<%=cthd.getMaHoaDon()%>', '<%=cthd.getMaSanPham()%>')">
											<i class="btn__icon fa-solid fa-trash"></i> Xóa
										</button>
									</div>
